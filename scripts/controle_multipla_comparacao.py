...
def main() -> None:
    ...
    # O dois-estagios ainda e tratado como experimento independente. Registramos o gate,
    # mas nao o misturamos ao conjunto pareado contra V2 enquanto nao existir comparacao
    # na mesma amostra comum V2/V3. Isso evita falsa precisao e cherry-picking.
    ...
    if dois:
        dois_status = {
            ...
            "incluido_no_holm_vs_v2": False,
            "motivo": "aguarda comparacao pareada na mesma amostra comum contra a V2 historica salva",
        }

    vencedores = [name for name, x in detalhes.items() if x["significativo_fwer_5pct"] and (x.get("diferenca_mae_desafiante_menos_v2") or 0) < 0]
    payload = {
        ...
        "regra_decisao": (
            ...
            "exigir delta favoravel e significancia apos Holm na mesma amostra pareada."
        ),
        "nota": (
